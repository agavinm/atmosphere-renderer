...
namespace RayleighScattering {
	...
	static const Float LambdaDependentValues[4][36] =
	...
	//	   http://augerlal.lal.in2p3.fr/pmwiki/uploads/Bucholtz.pdf
    template <typename Float>
	static const Float ScatteringCrossSection[4][90] = 
	 ...
	 */
    template <typename Float>
	const static Float ozoneUVcrossSection[2][7] =
	...
	*/
    template <typename Float>
	const static Float ozoneNearCrossSection[2][3] =
        { { 365, 405,455 },
	...
	*/
    template <typename Float>
	const static Float ozoneVisibleCrossSection[2][6] =
	...
	*/
    template <typename Float>
	const static Float ozoneNIRCrossSection[2][16] =
